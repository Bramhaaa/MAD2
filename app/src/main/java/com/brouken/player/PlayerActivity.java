...
public class PlayerActivity extends Activity {
    ...
    private ImageButton buttonUrlImport;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create URL Import button
        buttonUrlImport = new ImageButton(this, null, 0, R.style.ExoStyledControls_Button_Bottom);
        buttonUrlImport.setContentDescription("Import from URL");
        buttonUrlImport.setImageResource(R.drawable.ic_cloud_download_24dp); // Use download icon
        buttonUrlImport.setOnClickListener(view -> showUrlImportDialog());

        // Create Library button
        buttonLibrary = new ImageButton(this, null, 0, R.style.ExoStyledControls_Button_Bottom);
        buttonLibrary.setContentDescription("Media Library");
        buttonLibrary.setImageResource(R.drawable.ic_video_library_24dp); // Use library icon
        buttonLibrary.setOnClickListener(view -> showLibraryDialog());
        ...
        // Add URL Import and Library buttons
        controls.addView(buttonUrlImport);
        controls.addView(buttonLibrary);
        ...
        if (mPrefs.scopeUri != null || isTvBox) {
            ...
            if (mPrefs.scopeUri != null) {
                if ("com.android.externalstorage.documents".equals(mPrefs.mediaUri.getHost()) ||
                    ...
                    // Provider "com.android.providers.media.documents" when using "Videos" tab in file
